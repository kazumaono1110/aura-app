    ...
    <div className="flex flex-col items-center justify-center min-h-dvh px-6">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3.5 rounded-full bg-white text-gray-800 font-semibold flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors disabled:opacity-50"
        >
